...
const services: ServiceItem[] = [
  ...
  },
  {
    ...
    // Mantenha 'imageUrl'. O caminho deve começar com /img (sem 'public')
          ...
          >
            <div className="h-48 overflow-hidden relative">
              ...
              <img 
                ...
                onError={(e) => {
                  // Fallback caso a imagem local falhe ao carregar
            ...
            <div className="p-6">
              ...
              <a href="#contact" className="inline-block mt-4 text-primary-600 font-semibold hover:text-primary-700 group-hover:translate-x-1 transition-transform">
