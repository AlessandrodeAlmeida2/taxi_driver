...
const services: ServiceItem[] = [
  ...
  },
  {
    ...
    title: "Rota do Café",
    description:
      "Visite fazendas históricas da região, conheça o processo de colheita e deguste cafés especiais premiados da região.",
  ...
  },
  {
    ...
    description:
      "Recepção no desembarque (Viracopos/Guarulhos) e transporte seguro. Monitoramento de voo e pontualidade garantida.",
  ...
  },
  {
    ...
    description:
      "Conforto total para viagens saindo de Pinhal para cidades vizinhas ou capitais. Carros sedã e minivans disponíveis.",
    icon: <Building2 size={28} className="text-white" />,
    // Imagem da estrada/vinhedo
    imageUrl: "./img/viagem_executiva.png",
  },
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-20">
        <span className="text-primary-600 font-bold tracking-wider uppercase text-xs border border-primary-200 bg-primary-50 px-3 py-1 rounded-full">
          Nossos Serviços
        </span>
        ...
        <p className="mt-4 max-w-2xl text-xl text-slate-500 mx-auto font-light">
          A família D'Alvia Vicente oferece mais que transporte: oferecemos
          tranquilidade para você desfrutar o melhor da vida.
        </p>
      </div>
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  if (service.id === 4)
                    ...
                    target.src =
                      "https://images.unsplash.com/photo-1596423733638-34440632292f?q=80&w=800";
                  else if (service.id === 6)
                    target.src =
                      "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=80&w=800";
                  else
                    target.src =
                      "https://images.unsplash.com/photo-1532935296431-40e6d0431138?q=80&w=800";
                }}
              />
