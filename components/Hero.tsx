      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full h-full flex items-center">
        <div className="w-full md:w-3/4 lg:w-2/3 text-left">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6 shadow-black/50 drop-shadow-lg">
            ...
            <span className="text-primary-400">Família D'Alvia Vicente</span>
          </h1>

          <p className="text-lg md:text-xl text-slate-100 mb-10 max-w-3xl font-medium drop-shadow-md leading-relaxed">
            Experiências exclusivas nas melhores vinícolas, fazendas de café
            centenárias e turismo gastronômico da Toscana Paulista.
          </p>
